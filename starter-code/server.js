...
app.post('/articles', (request, response) => {
    ...
    // TODONE: Write a SQL query to retrieve the author_id from the authors table for the new article.
    // TODONE: In the provided array, add the author name as data for the SQL query.
        client.query(
    ...
    // TODONE: Write a SQL query to insert the new article using the author_id from our previous query.
    // TODONE: In the provided array, add the data from our new article, including the author_id, as data for the SQL query.
        client.query(
...
app.put('/articles/:id', function(request, response) {
    ...
    client.query(
        ...
        .then(() => {
            ...
            client.query(
                `UPDATE articles SET title = $1, category = $2, "publishedOn" = $3, body = $4 author_id = $5 WHERE article_id = $6`,
